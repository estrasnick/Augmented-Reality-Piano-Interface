...
public class InitializeSong : MonoBehaviour {
    ...
    static Bar dummyBar = new Bar(new List<Note>());
    ...
    static Song song = new Song(1, "Mary Had a Little Lamb", "I Don't Know", (int)Keys.cmaj, 4, 4, new List<Bar>() { dummyBar, firstBar, secondBar, thirdBar, fourthBar }, 60);
